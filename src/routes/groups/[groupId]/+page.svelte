...
<div class="container mx-auto px-4 py-8">
    ...
    <Tabs value="info" class="w-full">
        <TabsList class="grid w-full grid-cols-3">
            ...
            <TabsTrigger value="games"><CalendarDays class="mr-2 h-4 w-4" /> Upcoming Games</TabsTrigger>
        </TabsList>
                        ...
                        {#each upcomingGames as game, index}
                            <div class="flex justify-between items-center">
                                <div>
                                    ...
                                    <p class="text-sm text-muted-foreground">Date: {new Date(game.date_time).toLocaleString()}</p>
                                </div>
